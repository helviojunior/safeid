...
namespace IAM.Proxy
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Proxy.Program));
            ...
            if (!RunningAsService())
            {
                ...
                switch (parameter)
                {
                    ...
                    default:
                        Log.TextLog.Log("Proxy", "Iniciando em modo console...");
                        Console.WriteLine("Iniciando em modo console...");

                        IAMProxy col = new IAMProxy();
                        col.Start(args);
            ...
            {
                Log.TextLog.Log("Proxy", "Iniciando em modo serviço...");
                Console.Write("Iniciando em modo serviço...");

                ServiceBase[] ServicesToRun;
                ServicesToRun = new ServiceBase[] { new IAMProxy() };
