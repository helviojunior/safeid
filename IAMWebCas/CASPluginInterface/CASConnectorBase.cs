...
namespace CAS.PluginInterface
{
    ...
    {
        public DbBase Database { get; internal set; }
        ...
        public CASConnectorBase(DbBase database, Uri service, Dictionary<String, Object> config, Object state)
            :this()
        {
            SetStart(database, service, config, state);
        }

        public void SetStart(DbBase database, Uri service, Dictionary<String, Object> config, Object state)
        {
