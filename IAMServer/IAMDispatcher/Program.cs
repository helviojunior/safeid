...
namespace IAM.Dispatcher
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Dispatcher.Program));
            ...
            if (System.Environment.UserInteractive)
            {
                ...
                switch (parameter)
                {
                    ...
                    default:
                        ...
                        IAMDispatcher col = new IAMDispatcher();
                        col.Start(args);
            ...
            else
            {
                ...
                ServicesToRun = new ServiceBase[] { new IAMDispatcher() };
