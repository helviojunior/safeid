...
namespace IAM.Watchdog
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Watchdog.Program));
            ...
            if (System.Environment.UserInteractive)
            {
                ...
                switch (parameter)
                {
                    ...
                    default:
                        ...
                        IAMWatchdog col = new IAMWatchdog();
                        col.Start(args);
            ...
            else
            {
                ...
                ServicesToRun = new ServiceBase[] { new IAMWatchdog() };
