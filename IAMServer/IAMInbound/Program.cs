...
namespace IAM.Inbound
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Inbound.Program));
            ...
            else
            {
                ...
                ServicesToRun = new ServiceBase[] { new IAMInbound() };
