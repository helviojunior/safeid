...
namespace IAM.Engine
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Engine.Program));
            ...
            else
            {
                ...
                ServicesToRun = new ServiceBase[] { new IAMEngine() };
