...
namespace IAM.Backup
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Backup.Program));
            ...
            else
            {
                ...
                ServicesToRun = new ServiceBase[] { new IAMBackup() };
