...
namespace IAM.Messenger
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Reflection.Assembly asm = System.Reflection.Assembly.GetAssembly(typeof(IAM.Messenger.Program));
            ...
            if (System.Environment.UserInteractive)
            {
                ...
                switch (parameter)
                {
                    ...
                    default:
                        ...
                        IAMWorkflowProcessor col = new IAMWorkflowProcessor();
                        col.Start(args);
            ...
            else
            {
                ...
                ServicesToRun = new ServiceBase[] { new IAMWorkflowProcessor() };
