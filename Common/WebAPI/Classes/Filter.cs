...
namespace IAM.WebAPI.Classes
{
    ...
    internal class Filter : APIBase
    {
        ...
        public override Object Process(SqlConnection sqlConnection, Int64 enterpriseId, String method, String auth, Dictionary<String, Object> parameters)
        {
            ...
            {
                case "new":
                    return newfilter(sqlConnection, parameters);
                    break;
                ...
                case "use":
                    return use(sqlConnection, parameters);
                    break;
        ...
        private Boolean delete(SqlConnection sqlConnection, Dictionary<String, Object> parameters)
        {
            ...
            ExecuteNonQuery(sqlConnection, "delete from filters where id = @filter_id", CommandType.Text, par);
            AddUserLog(sqlConnection, LogKey.Filter_Deleted, null, "API", UserLogLevel.Info, 0, this._enterpriseId, 0, 0, 0, 0, 0, "Filter " + dtFilter.Rows[0]["name"] + " deleted", "", acl.EntityId);
        ...
        /// <param name="sqlConnection">Conexão com o banco de dados MS-SQL</param>
        /// <param name="parameters">Dicionário (String, Object) contendo todos os parâmetros necessários</param>
        private List<Dictionary<String, Object>> use(SqlConnection sqlConnection, Dictionary<String, Object> parameters)
        {
            ...
            DataTable dtFilters = ExecuteDataTable(sqlConnection, sql, CommandType.Text, par, null);
