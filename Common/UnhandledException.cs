...
public class UnhandledException
{
    ...
    static public String WriteEvent(object sender, Exception ex, Boolean endApplication)
    {
        ...
        try
        {
            ...
            BinaryWriter writer = new BinaryWriter(File.Open(Path.GetDirectoryName(asm.Location) + "\\Exception_" + DateTime.Now.ToString("yyyyMMdd") + ".txt", FileMode.Append));
    ...
    static public String WriteEvent(object sender, UnhandledExceptionEventArgs e, Boolean endApplication)
    {
        ...
        try
        {
            ...
            String error = WriteEvent(sender, ex, endApplication);
