...
namespace IAM.WebAPI.Classes
{
    ...
    /// </summary>
    internal class SystemRole : IAMAPIBase
    {
        ...
        public override Object iProcess(IAMDatabase database, Int64 enterpriseId, String method, String auth, Dictionary<String, Object> parameters)
        {
            ...
            switch (mp[1])
            {
                ...
                case "permissions":
                    return permissions(database, parameters);
                    break;

                case "permissionstree":
                    return permissionstree(database, parameters);
                    break;
                ...
                case "changepermissions":
                    return changepermissions(database, parameters);
                    break;
        ...
        private Boolean deleteallusers(IAMDatabase database, Dictionary<String, Object> parameters)
        {
            ...
            database.ExecuteNonQuery( "delete from sys_entity_role where role_id = @role_id", CommandType.Text, par);
